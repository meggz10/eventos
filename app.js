...
pool.query('UPDATE eventos_arbol2 SET mic = 1');
...
pool.query('UPDATE eventos_arbol2 SET mic = 0');
...
conexion.connect();
conexion.query('UPDATE eventos_arbol2 SET face = "happy2.png"');
conexion.end();
...
conexion.connect();
conexion.query('UPDATE eventos_arbol2 SET face = "happy.png"');
conexion.end();
...
conexion.connect();
conexion.query('UPDATE eventos_arbol2 SET face = "angry.png"');
conexion.end();
