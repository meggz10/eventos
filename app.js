...
PoolFuncionMysqlmic_remoto_1 = (res) => {
  ...
  pool.query('UPDATE eventos_arbol6 SET mic = "1"');
  ...
  PoolFuncionMysqlmic_remoto_0 = (res) => {
    ...
    pool.query('UPDATE eventos_arbol6 SET mic = "0"');
...
pool.query('UPDATE eventos_arbol6 SET face = "main.gif"');
...
pool.query('UPDATE eventos_arbol6 SET face = "Hablar.gif"');
...
pool.query('UPDATE eventos_arbol6 SET face = "Miedo.gif"');
...
pool.query('UPDATE eventos_arbol6 SET face = "Asombro.gif"');
...
pool.query('UPDATE eventos_arbol6 SET face = "Confusion.gif"');
...
pool.query('UPDATE eventos_arbol6 SET face = "Triste.gif"');
...
pool.query('UPDATE eventos_arbol6 SET face = "Feliz.gif"');
...
pool.query('UPDATE eventos_arbol6 SET face = "Ternura.gif"');
...
pool.query('UPDATE eventos_arbol6 SET face = "Enojo.gif"');
...
pool.query('UPDATE eventos_arbol6 SET face = "Orgullo.gif"');
